              ...
              <div class="card">
                <div class="card-header">
                      <!-- <i class="link-icon float-start" data-feather="arrow-left"></i> -->
                       &nbsp;&nbsp;&nbsp;
                      <h6 class="card-title mb-0 float-start">{{ $t("PermissionAdd") }} </h6>
                      <button
    ...
    submitData() {
      this.$swal({
        ...
        if (result.value) {
          ...
          formData.append("controller", this.forms.controller);
       
          const baseURI  =  this.$settings.endPoint+"permission/create";
