              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  >
                    ...
                    <div class="row mb-3">
                      <div class="col-lg-2">
                        <label for="defaultconfig" class="col-form-label">File</label>
                      </div>
                      <div class="col-lg-8">
                    ...
                    <div class="card-footer">
                      <button
                        class="btn btn-warning float-start btn-xs"
                        @click="backForm"
                        type="button"
                      >
                      <i class="link-icon float-start" data-feather="arrow-left"></i>
                      ...
                      &nbsp;&nbsp;&nbsp;
                      <button class="btn btn-primary float-end btn-xs" type="submit">
...
export default {
  ...
  methods: {
    ...
    downloadData() {
      const baseURI = this.$settings.endPoint + "/company/download-template";

      var file_name = "template_upload_company.xlsx";
    ...
    submitData() {
      this.$swal({
        ...
        if (result.value) {
          ...
          formData.append("file", this.forms.code);
