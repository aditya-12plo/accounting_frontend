                  ...
                  >
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-lg-8">
                        ...
                        <select class="form-control" name="status" id="status" v-model="forms.status" >
    ...
    submitData() {
      this.$swal({
        ...
        if (result.value) {
          ...
          const baseURI =
            this.$settings.endPoint + "company/update/" + this.forms.company_id;
          this.$http
            ...
            .then((response) => {
              ...
              if (response.data.status === 200) {
                ...
                //window.history.back();
                var params = this.$onRandom(this.forms.company_id);
