				...
				<div id="kt_aside" class="aside aside-extended" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="auto" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_toggle">
					...
					<div class="aside-primary d-flex flex-column align-items-lg-center flex-row-auto">
						...
						<div class="aside-logo d-none d-lg-flex flex-column align-items-center flex-column-auto py-10" id="kt_aside_logo">
							<a :href="this.$settings.endPointApp+'/dashboard'">
								<img alt="ICDX GROUP" src="/assets/images/icon_64x64.8a9f2f.png" class="h-35px" />
							</a>
						</div>
						<!--end::Logo-->
						...
						<div class="aside-footer d-flex flex-column align-items-center flex-column-auto" id="kt_aside_footer">
							...
							<div class="d-flex align-items-center mb-10" id="kt_header_user_menu_toggle">
								<!--begin::Menu wrapper-->
								<div class="cursor-pointer symbol symbol-40px" data-kt-menu-trigger="click" data-kt-menu-overflow="true" data-kt-menu-placement="top-start" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-dismiss="click" :title="$t('txtUserSetting')">
									<img src="/assets/images/profile-user.png" alt="image" />
								</div>
								...
								<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
									...
									<div class="menu-item px-3">
										<div class="menu-content d-flex align-items-center px-3">
											...
											<div class="symbol symbol-50px me-5">
												<img alt="Logo" src="/assets/images/profile-user.png" />
											</div>
											<!--end::Avatar-->
											<!--begin::Username-->
											<div class="d-flex flex-column">
												<div class="fw-bolder d-flex align-items-center fs-5">{{this.name}}</div>
												<a href="#" class="fw-bold text-muted text-hover-primary fs-7">{{this.email}}</a>
											</div>
											<!--end::Username-->
										</div>
									</div>
									...
									<div class="menu-item px-5">
										<a :href="this.$settings.endPointApp+'/user/profile'" class="menu-link px-5">{{ $t('txtMyProfile') }}</a>
									</div>
									<!--end::Menu item-->
									...
									<div class="menu-item px-5" data-kt-menu-trigger="hover" data-kt-menu-placement="right-end">
										<a href="#" class="menu-link px-5">
											<span class="menu-title position-relative">{{ $t('txtLanguage') }}

                        <span v-if="this.locale=='id'" class="fs-8 rounded bg-light px-3 py-2 position-absolute translate-middle-y top-50 end-0">
                          Indonesia<img class="w-15px h-15px rounded-1 ms-2" src="/assets/images/indonesia.svg" alt="indonesia" />
                        </span>
                        <span v-else class="fs-8 rounded bg-light px-3 py-2 position-absolute translate-middle-y top-50 end-0">
                          English<img class="w-15px h-15px rounded-1 ms-2" src="/assets/images/united-states.svg" alt="English" />
                        </span>
                      ...
                      <div v-if="this.locale=='id'">
                        ...
                        <!--begin::Menu item-->
                        <div class="menu-item px-3">
                          <a @click="langChanged('en')" class="menu-link d-flex px-5">
                          <span class="symbol symbol-20px me-4">
                            <img class="rounded-1" src="/assets/images/united-states.svg" alt="" />
                          </span>English</a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        <div class="menu-item px-3">
                          <a @click="langChanged('id')" class="menu-link d-flex px-5 active">
                          <span class="symbol symbol-20px me-4">
                            <img class="rounded-1" src="/assets/images/indonesia.svg" alt="" />
                          </span>Indonesia</a>
                        </div>
                        <!--end::Menu item-->
                      ...
                      <div v-else>
                        ...
                        <!--begin::Menu item-->
                        <div class="menu-item px-3">
                          <a @click="langChanged('en')" class="menu-link d-flex px-5 active">
                          <span class="symbol symbol-20px me-4">
                            <img class="rounded-1" src="/assets/images/united-states.svg" alt="" />
                          </span>English</a>
                        </div>
                        ...
                        <!--begin::Menu item-->
                        <div class="menu-item px-3">
                          <a @click="langChanged('id')" class="menu-link d-flex px-5">
                          <span class="symbol symbol-20px me-4">
                            <img class="rounded-1" src="/assets/images/indonesia.svg" alt="" />
                          </span>Indonesia</a>
                        </div>
                        <!--end::Menu item-->
									...
									<!--begin::Menu item-->
									<div class="menu-item px-5">
										<a @click="logout()" class="menu-link px-5">{{ $t('txtSignOut') }}</a>
									</div>
									<!--end::Menu item-->
									<!--begin::Menu separator-->
									<div class="separator my-2"></div>
										...
										<div class="tab-pane fade active show" id="kt_aside_nav_tab_menu" role="tabpanel">
											...
											<div class="menu menu-column menu-fit menu-rounded menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-bold fs-5 px-6 my-5 my-lg-0" id="kt_aside_menu" data-kt-menu="true">
												<div id="kt_aside_menu_wrapper" class="menu-fit">
													...
													<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
														...
														<div class="menu-sub menu-sub-accordion menu-active-bg">
															...
															<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
																...
																<div class="menu-sub menu-sub-accordion menu-active-bg">
																	<div class="menu-item">
																		<a class="menu-link" href="../../demo7/dist/pages/pricing/pricing-1.html">
																			<span class="menu-bullet">
																				<span class="bullet bullet-dot"></span>
																			</span>
																	...
																	<div class="menu-item">
																		<a class="menu-link" href="../../demo7/dist/pages/pricing/pricing-2.html">
																			<span class="menu-bullet">
																				<span class="bullet bullet-dot"></span>
																			</span>
													...
													<div class="menu-item">
														<a class="menu-link" href="https://preview.keenthemes.com/metronic8/demo7/layout-builder.html" title="Build your layout and export HTML for server side integration" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
															<span class="menu-icon">
