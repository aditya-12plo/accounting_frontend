                                            ...
                                            <form class="form form-horizontal" @submit.prevent="submitData" method="POST">
                                                <div class="form-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8 form-group">
                                                            <input type="password" class="form-control" v-model="forms.password" aria-describedby="passwordHelp" autofocus>
...
export default {
  ...
  data () {
    return {  
      ...
      datasUser:[],
      datasDivision:[],
      forms:{user_id:'',email:'',name:'',status:'',division_id:'',password:''},
    }
  },
    watch: { 
    ...
    methods: {
        ...
        fetchData() {
            ...
            return this.$http.get(baseURI).then((response) => {
                ...
                this.forms.division_id   = response.data.datas.division_id
                this.forms.password      = ''
